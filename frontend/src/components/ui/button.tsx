...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-green-500 text-white hover:bg-green-600 active:scale-95 shadow-[0_4px_0_#16a34a] active:shadow-none active:translate-y-1",
        destructive: "bg-red-500 text-white hover:bg-red-600 shadow-[0_4px_0_#dc2626] active:shadow-none active:translate-y-1",
